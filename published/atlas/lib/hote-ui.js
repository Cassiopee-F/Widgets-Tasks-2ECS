...
import { capacites, creerClient } from './data-client.js?v=1.3.0';
import { installerAdaptateur } from './grist-adapter.js?v=1.3.0';
import { listerScenesAtlas } from './decouverte.js?v=1.3.0';
import {
